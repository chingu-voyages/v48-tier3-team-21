    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <div className="terms-content">
        ...
        <p className="mb-4">
          ...
          <br />
          All content included in our app, such as text, graphics, logos,
          images, audio clips, video clips, digital downloads, data
          compilations, and software, is the property of our app or its content
          suppliers and protected by international copyright laws.
        </p>
        <p className="mb-4">
          <strong>5. Limitation of Liability</strong>
          <br />
          In no event shall our app, its directors, officers, employees, or
