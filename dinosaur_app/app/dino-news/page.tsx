  ...
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <main className="w-full bg-white p-20 max-md:p-8 flex flex-col gap-5">
        ...
        <h2 className=" text-3xl max-md:text-lg max-lg:text-xl font-light ">
          <em>
            Dive into the exciting world of dinosaurs! Find news about fossils,
            research, and everything that makes these giants roar. From the
            worlds best sources and inquisitive publishers all over the world.
          </em>
        </h2>
          ...
          {dinoNews.map((news) => (
            ...
            >
              ...
              <div className=" grow flex flex-col gap-2 text-white lg:max-h-[350px]">
                ...
                {/* title */}
                <h3 className="text-5xl max-lg:text-2xl font-bold mt-3">
                  {news.title}
                </h3>
                ...
                <Link
                  ...
                  className=" lg:absolute lg:bottom-2 lg:right-2 w-[200px] font-extrabold bg-orange-300 hover:bg-orange-400 p-3 rounded-lg max-lg:self-end"
                >
                  Read More
                </Link>
              </div>
