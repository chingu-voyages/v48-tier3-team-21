...
const Marker = ({
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger>
        <div className=" bg-orange-500 bg-opacity-50 font-semibold rounded-full flex items-center justify-center p-[1px] border border-orange-600">
        ...
        <div className="w-full flex flex-col items-center border-4 border-orange-300 rounded-xl ">
          ...
          <div className="w-full bg-black text-white flex flex-col items-center p-2 gap-4 rounded-lg rounded-t-none">
            ...
            <Link
              href={`${
                decade == "all-dinos"
                  ? "/explore-dino/?foundIn=" + foundIn
                  : "/explore-dino/?foundIn=" + foundIn + "&decade=" + decade
              } `}
